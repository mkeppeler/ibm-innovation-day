...
const navHeight =
  ...
  document.querySelector(".header__img").height;
...
// message.textContent =
// 'We use cookied for improved functionallity and analytics.';
message.innerHTML =
...
//   //Remove Eventhandler after it was called
...
const linearGradient = logo.getElementsByTagName("linearGradient")[0];

logo.addEventListener("click", () => {
  if (linearGradient.getAttribute("x2") === "100%") {
